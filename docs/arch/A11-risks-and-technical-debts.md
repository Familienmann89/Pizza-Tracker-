...
| R-05 | **Verweise auf nicht enthaltene Seiten (behoben).** Im Basisstand vorhandene Dokumentationsverweise auf nicht enthaltene Datenschutz- und Impressumsseiten wurden entfernt. Eigene Seiten sind in der M3-Version nicht enthalten. | Vor der Korrektur hätten Prüfer oder Nutzer Verweisen auf nicht vorhandene Seiten folgen können. | – | – | Verweise in `README.md`, `INSTALL.md`, P1 und B1 entfernt; interne Links geprüft. **Status: behoben.** |
...
Zuerst müssen Installation und zentrale Abläufe reproduzierbar geprüft werden. R-02, R-03 und R-06 betreffen die fachliche Korrektheit und sind bereits für die Abnahme relevant, nicht erst für einen späteren produktiven Einsatz. R-01 kann die Vorführung beeinträchtigen; R-05 ist behoben. R-04 wird besonders bei Ausfällen von Datenbank, Dateien oder Verbindung wirksam.
